...
# ])
# Novelty.create!([
#   {name: "Lightsaber", description: "Part laser, part samuri sword, all awesome. The lightsaber is an elogant weapon for a more civilized age, not nearly as clumsy as a blaster", price: 270, supplier_id: 1},
...
CategoriedNovelties.create([
  {category_id: 1, novelty_id: 1},
  {category_id: 1, novelty_id: 5},
  {category_id: 1, novelty_id: 6},
  {category_id: 2, novelty_id: 1},
  {category_id: 2, novelty_id: 2},
  {category_id: 2, novelty_id: 4},
  {category_id: 2, novelty_id: 5},
  {category_id: 2, novelty_id: 6},
  {category_id: 3, novelty_id: 1},
  {category_id: 3, novelty_id: 3},
  {category_id: 3, novelty_id: 4},
  {category_id: 3, novelty_id: 6},
  {category_id: 4, novelty_id: 3},
  {category_id: 5, novelty_id: 2},
  {category_id: 5, novelty_id: 3},
  {category_id: 6, novelty_id: 1},
  {category_id: 6, novelty_id: 3},
  {category_id: 6, novelty_id: 4},
  {category_id: 6, novelty_id: 5}
])
